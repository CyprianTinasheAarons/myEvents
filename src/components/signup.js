...
<div className="row">
                              <div className="col-md-3 mx-auto m-1 p-1">
                                  <div className="card">
                                      <div className="card-body">
                                        ...
                                        <div className="form-group"><button className="btn  btn-block text-dark  btn-danger" type="submit"><strong>Sigup with Email </strong></button>
            </div>
            ...
            </div><a  href="#">Already have a account?Login</a></form>
